package com.bharathy.medicare.controllers;
...
import com.bharathy.medicare.models.Cart;
import com.bharathy.medicare.models.ProductRepository;
import com.bharathy.medicare.models.data.Product;
    ...
    public String add(@PathVariable int id, HttpSession session, Model model, @RequestParam(value = "cartPage", required = false) String cartPage) {
        ...
        if (session.getAttribute("cart") == null) {
            ...
            if (cart.containsKey(id)) {
                ...
                cart.put(id, new Cart(id, product.getName(), product.getPrice(), ++qty));
            } else {
                cart.put(id, new Cart(id, product.getName(), product.getPrice(), 1));
                session.setAttribute("cart", cart);
            }
